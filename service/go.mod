...
replace github.com/itgram/minion.persistence.cassandra => ../../minion.persistence.cassandra
...
require (
	...
	github.com/itgram/minion.persistence.cassandra v0.0.0-00010101000000-000000000000
