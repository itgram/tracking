...
require (
	github.com/WhatsLab/grain.encoding v0.1.0
	github.com/WhatsLab/grain.encoding.protobuf v0.1.0
	github.com/WhatsLab/grain.fabric v0.1.0
	github.com/WhatsLab/grain.persistence v0.1.0
	github.com/WhatsLab/grain.persistence.esdb v0.1.0
